      ...
      Container(
        child: Padding(
          ...
          child: Column(children: [
            ...
            // comment section
            CommentAdd("Tonymontana",
                "Harika bir fotoğraf bayıldım gerçekten mükemmel."),
            CommentAdd(
                "Elchapo", "Harika dostum çok kaliteli"),
          ]),
        ),
      );
                ...
                children: [
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        storyWidget("assets/images/c1.jpg", "EnesAlvrgl"),
                        storyWidget("assets/images/c2.jpg", "Keyvan Arasteh"),
                        storyWidget("assets/images/c3.jpg", "Ahmet Selim Över"),
                        storyWidget("assets/images/c4.jpg", "Ramazan Şen"),
                      ],
                    ),
                  ),
                  //you can add new post here
                  postItem("assets/images/c1.jpg", "assets/images/galata.webp",
                      "EnesAlvrgl", "Galata Kulesi"),
                  postItem("assets/images/c2.jpg", "assets/images/c5.jpg",
                      "Keyvan Arasteh", "PabloEscobar"),
                  postItem("assets/images/c3.jpg", "assets/images/c6.jpg",
                      "Ahmet Selim Över", "tupac"),
                  postItem("assets/images/c4.jpg", "assets/images/warship.jpg",
                      "Ramazan Şen", "Pacific Ocean"),
                ],
              ),
            ),
          )),
